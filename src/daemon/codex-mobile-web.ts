...
(function () {
  ...
  var PERSISTENT_MOBILE_CACHE_KEY = "deskrelayMobileCacheV1";
  ...
  function persistentStorageGet() {
    try {
      return localStorage.getItem(PERSISTENT_MOBILE_CACHE_KEY);
    } catch (_) {
      return null;
    }
  }
  ...
  function persistentStorageSet(value) {
    try {
      localStorage.setItem(PERSISTENT_MOBILE_CACHE_KEY, value);
      return true;
    } catch (_) {
      return false;
    }
  ...
  function clearPersistentMobileCache() {
    ...
    try {
      localStorage.removeItem(PERSISTENT_MOBILE_CACHE_KEY);
    } catch (_) {}
  }
